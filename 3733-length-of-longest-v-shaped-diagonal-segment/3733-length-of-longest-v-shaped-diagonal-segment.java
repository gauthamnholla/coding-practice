/**
 * Finds the longest diagonal path in the grid.
 * Path alternates between 1 and 2, starting from 1,
 * and allows at most one turn in direction.
 * Uses DFS with memoization and pruning.
